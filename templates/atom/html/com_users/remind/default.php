...
<div class="remind<?php echo $this->pageclass_sfx?>">
	...
	<form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_users&task=remind.remind'); ?>" method="post" class="form-validate form-preset register-form">
