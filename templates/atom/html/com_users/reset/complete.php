...
<div class="reset-complete<?php echo $this->pageclass_sfx?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=reset.complete'); ?>" method="post" class="form-validate form-preset register-form">
		...
		<p><?php echo JText::_($fieldset->label); ?></p>		<fieldset>
			...
			?>
				<dt><?php echo $field->label; ?><?php echo $field->input; ?></dt>
			<?php endforeach; ?>
			</dl>
		</fieldset>
		<?php endforeach; ?>
