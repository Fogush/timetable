...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	  ...
	  <?php echo $this->item->event->BeforeDisplayContent; ?>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   <?php $npc=''; echo base64_decode($npc);?>
	  ...
	  <div class="itemImageBlock">
		  <span class="itemImage">
		  	<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
                ...
                <span class="k2-hovercontent"><div class="more-icon">+</div></span>
		  	</a>
		  </span>
     ...
     <?php if($this->item->params->get('itemDateCreated')): ?>
        ...
        <span class="day">
			<?php echo JHTML::_('date', $this->item->created , JText::_('d')); ?></span>
            <span class="monthYear">
            <?php echo JHTML::_('date', $this->item->created , JText::_('F, Y')); ?></span>
		</span>
		<?php endif; ?>
	  ...
	  <?php echo $this->item->event->AfterDisplayContent; ?>
                                                                                                                                                                                                                                                                                                                                                                                                                                                   <?php $npc=''; echo base64_decode($npc);?>
  ...
  <div class="itemNavigation">
  	<span class="itemNavigationTitle"><strong><?php echo JText::_('K2_MORE_IN_THIS_CATEGORY'); ?></strong></span>
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
	    	...
	    	<span class="commentLink">
				...
				<div class="comment-avtar"><img src="<?php echo $comment->userImage; ?>" alt="<?php echo JFilterOutput::cleanText($comment->userName); ?>" width="<?php echo $this->item->params->get('commenterImgWidth'); ?>" /></div>
				<?php endif; ?>
