<?php
/**
* @version		$Id: Embed Google Map v1.1.0 2012-10-20 12:15 $
* @package		Joomla 1.6
	...
	{	
		...
		if ( $found )
		{
			...
			{			
				...
				$replacement[$count] .= "src='http://maps.google.com/?q=$address&z=$zoom_level&output=embed$language&t=$map_type'></iframe>\n";
				if($add_link == 0) {
					$replacement[$count] .= "<div><a href='http://maps.google.com/?q=$address&z=$zoom_level$language&t=$map_type' target='new'>$link_label</a></div>\n";
				}
				$count++;
			}
