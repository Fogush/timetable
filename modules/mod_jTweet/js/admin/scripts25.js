...
jQuery(document).ready(function() {
	...
	switch (jQuery('#jform_params_source :selected').text()) {
		case 'User tweets':
			jQuery("#jform_params_username,#jform_params_username-lbl,#jform_params_tweetList,#jform_params_tweetList-lbl,.twitterlist").show();
			jQuery("#jform_params_query,#jform_params_query-lbl").hide();
			break;

		case 'Twitter search':
			jQuery("#jform_params_query,#jform_params_query-lbl").show();
			jQuery("#jform_params_username,#jform_params_username-lbl,#jform_params_tweetList,#jform_params_tweetList-lbl,.twitterlist").hide();
			break;
	}
	...
	switch (jQuery('#jform_params_tweetLayout :selected').text()) {
		case 'Scroller':
			jQuery("#jform_params_height,#jform_params_height-lbl,.moduleheight").show();
			break;

		case 'Default':
			jQuery("#jform_params_height,#jform_params_height-lbl,.moduleheight").hide();
			break;
	...
	if(jQuery("#sortable li.avatar").length == 1)  {
		jQuery("#jform_params_avatarSize,.avatardescription,.Avatar h2,#jform_params_avatarSize-lbl").show();
	}
	else {
		jQuery("#jform_params_avatarSize,.avatardescription,.Avatar h2,#jform_params_avatarSize-lbl").hide();
	}

	// Hides options based on whether the icona tag is used in the display
	if(jQuery("#sortable li.icon").length == 1)  {
		jQuery("#jform_params_twitterBird-lbl,#jform_params_twitterBird,.icondescription").show();
	}
	else {
		jQuery("#jform_params_twitterBird-lbl,#jform_params_twitterBird,.icondescription").hide();
	}
	...
	if(jQuery("#sortable li.column1").length == 1)  {
		col1 = 1;
		jQuery("#jform_params_col1Width,#jform_params_col1Width-lbl").show();
	}
	else {
	col1 = 0;
		jQuery("#jform_params_col1Width,#jform_params_col1Width-lbl").hide();
	}

	// Hides options based on whether the tag is used int he display
	if(jQuery("#sortable li.column2").length == 1)  {
		col2 = 1;
		jQuery("#jform_params_col2Width,#jform_params_col2Width-lbl").show();
	}
	else {
	col2 = 0;
		jQuery("#jform_params_col2Width,#jform_params_col2Width-lbl").hide();
	}

	// Hides options based on whether the tag is used int he display
	if(jQuery("#sortable li.column3").length == 1)  {
		col3 = 1;
		jQuery("#jform_params_col3Width,#jform_params_col3Width-lbl").show();
	}
	else {
	col3 = 0;
		jQuery("#jform_params_col3Width,#jform_params_col3Width-lbl").hide();
	}


	if((col1 + col2 + col3) > 0) {
		jQuery(".moduleheader.Column.Widths,.columnwidths,.Columns").show();
	}
	else {
		jQuery(".moduleheader.Column.Widths,.columnwidths,.Columns").hide();
	}
	...
	jQuery(".panel select").change(function () {
